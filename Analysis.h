...
struct sortByEnergyCsI {
    inline bool operator() (const CsIDet& EnCsI_1,
                            const CsIDet& EnCsI_2){
        return (EnCsI_1.energy>EnCsI_2.energy);
    }
};
...
public :
    ...
    TH1D *hYdElastic[16];
    TH2D *hYdCsI1_Tot, *hCsIAnPIDDeuteron, *hYdCsI1Tot_AnPIDDeuteron;
    ...
    std::pair<double, double> Csi1RingSectorCalibration[16][16];//16 sectors of csi1 and 16 rings of Yd
